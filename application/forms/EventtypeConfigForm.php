...
class EventtypeConfigForm extends RepositoryForm
{
    public function init()
    {
        ...
        $this->redirectUrl = 'graylog/eventtypes';
    }
    ...
    protected function onUpdateSuccess()
    {
        if ($this->getElement('btn_remove')->isChecked()) {
            $this->setRedirectUrl("graylog/eventtypes/delete?eventtype={$this->getIdentifier()}");
            $success = true;
        } else {
    ...
    protected function createBaseElements(array $formData)
    {
        ...
        $this->addElement(
            ...
            'instance',
            array(
                'description'   => $this->translate('Graylog instance'),
                'label'         => $this->translate('Graylog Instance'),
        ...
        $this->addElement(
            ...
            'index',
            array(
                'description'   => $this->translate('Graylog index pattern'), //TODO: streams?
        ...
        $this->addElement(
            ...
            'filter',
            array(
                'description'   => $this->translate('Graylog filter in the Icinga Web 2 filter format'),
